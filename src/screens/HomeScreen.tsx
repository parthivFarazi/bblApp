  ...
  return (
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.card}>
          <Text style={styles.cardLabel}>Scheduling</Text>
          <Text style={styles.cardCopy}>
            {isBrother
              ? 'Reserve a table block or review upcoming DU bookings.'
              : 'View upcoming reservations. DU brothers can reserve blocks.'}
          </Text>
          <Pressable
            style={styles.primaryButtonAlt}
            onPress={() => navigation.navigate('Scheduling')}
          >
            <Text style={styles.primaryLabel}>{isBrother ? 'Open Scheduling' : 'View Schedule'}</Text>
          </Pressable>
        </View>
